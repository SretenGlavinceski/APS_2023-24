...
//        int roads = Integer.parseInt(br.readLine()); // no need???
//
...
//        String lastCity = br.readLine();
//
//        graph.printPath(startCity, lastCity);
//        System.out.println();
//        graph.printPath(lastCity, startCity);
//        System.out.println();
//
//        Map<String, Integer> firstCityPaths = graph.shortestPath(startCity);
//        Map<String, Integer> lastCityPaths = graph.shortestPath(lastCity);
//
//        System.out.println(firstCityPaths.get(lastCity) + lastCityPaths.get(startCity));
//    }
//}
