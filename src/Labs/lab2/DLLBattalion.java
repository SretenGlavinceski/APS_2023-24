...
public class DLLBattalion {
    ...
    public static void battalion(DLL<Integer> list, int a, int b) {
        DLLNode<Integer> current = list.find(a);

        DLLNode<Integer> first = current;
        DLLNode<Integer> last = list.find(b);
        DLLNode<Integer> end = last.succ;

        DLLNode<Integer> beforeFirst = current.pred;
        DLLNode<Integer> afterLast = last.succ;
        ...
        while (current!=end) {
            DLLNode<Integer> temp = current.pred;
            current.pred = current.succ;
            current.succ = temp;
            current = current.pred;
        }
        ...
        if (beforeFirst == null) {
            first.succ = afterLast;
            afterLast.pred = first;
            list.setFirst(last);
            last.pred = null;
        } else if (afterLast == null) {
